// fixed_optimized_video_generator.js - Fixed standalone optimized video generator
...
class FixedOptimizedVideoGenerator {
  ...
  setupPaths() {
    ...
    this.UNIQUE_FRAMES_DIR = path.join(this.OUTPUT_DIR, 'unique_frames');
...
async function main() {
  try {
    ...
    if (!scriptPath) {
      console.log(`
🚀 Fixed Optimized Video Generator
...
Usage:
  node fixed_optimized_video_generator.js <script_path> [video_name]

Examples:
  node fixed_optimized_video_generator.js output/chemistry/acids_bases/generated_script.js
  node fixed_optimized_video_generator.js output/chemistry/acids_bases/generated_script.js "fast_video"
